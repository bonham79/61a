...
def move_stack(n, start, end):
    ...
    if n == 1:
        ...
        move_stack(n-1, start, 6-start-end), move_stack(1, start, end), move_stack(n-1, 6-start-end, end)
...
def balanced(m):
    ...
    if is_weight(m):
        ...
        return total_weight(end(left)) * length(left) == total_weight(end(right)) * length(right) and balanced(end(left)) and balanced(end(right))
...
def make_fib():
    ...
    def fib():
        nonlocal fib_list
        fib_list[0], fib_list[1], fib_list[2] = fib_list[1], fib_list[0] + fib_list[1], fib_list[0]
        return fib_list[2]
    return fib
...
def make_withdraw(balance, password):
    ...
    "Your account is locked. Attempts: ['hwat', 'a', 'n00b']"
    """
    user_password, password_list, password_counter =  password, [], 0
    def password_withdraw(amount, password):
        nonlocal balance, password_list, password_counter
...
def make_joint(withdraw, old_password, new_password):
    ...
    "Your account is locked. Attempts: ['my', 'secret', 'password']"
    """
    correct = withdraw(0, old_password)
